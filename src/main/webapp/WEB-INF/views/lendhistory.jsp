      ...
      <div class="content">
        ...
        <div class="booklist-table">
            <table class="styled-table">
                ...
                <tbody>
               <c:forEach var="lends" items="${lendhistory}">
                    <tr>
                        <td>${lends.lendid}</td>
                        <td>${lends.userid}</td>
                        <td>${lends.bookid}</td>
                        <td>${lends.requestdate}</td>
                        <td>${lends.defaultreturndate}</td>
                        <td>${lends.actualreturndate}</td>
                        <td>${lends.fineamount}</td>
                        <td>${lends.requeststatus}</td>
                    </tr>
                    </c:forEach>            
                    <!-- and so on... -->
                </tbody>
