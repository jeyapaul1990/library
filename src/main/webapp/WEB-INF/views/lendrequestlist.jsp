      ...
      <div class="content">
        <div class="booklist-table">
            <table class="styled-table">
                ...
                <tbody>
               <c:forEach var="lends" items="${lendlist}">
	<tr>
		<td>${lends.lendid}</td>
		<td>${lends.userid}</td>
		<td>${lends.bookid}</td>
		<td>
                            <a href="approverequest/${lends.lendid}" class="approvebutton" style="vertical-align:middle"><span>Approve</span></a>
                            <a href="rejectrequest/${lends.lendid}" class="rejectbutton" style="vertical-align:middle"><span>Reject</span></a>
