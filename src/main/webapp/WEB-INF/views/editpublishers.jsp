...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/css/bootstrap.min.css" rel="stylesheet">
  ...
  <link rel="stylesheet" href="/LibraryManagementFinal/resources/css/style.css">
...
<body>
    <div class="container">
        ...
        <div class="LogoImg">
            <a href="/LibraryManagementFinal/"><img src="/LibraryManagementFinal/resources/images/others/books.png"/> </a>
        </div>
    ...
    <div class="homepagemenu">
        <ul class="homepagemenuitems">
            ...
            <li><a href="/LibraryManagementFinal/login">Logout <i class="fa fa-sign-out" aria-hidden="true"></i></a></li>
        </ul>
    </div>
    <div id="navbar">
        <a href="/LibraryManagementFinal/booksinventory">Book Inventory</a>
        <a href="/LibraryManagementFinal/authorrecords">Authors</a>
        <a class="active" href="/LibraryManagementFinal/publisherrecords">Publishers</a>
        <a href="/LibraryManagementFinal/userrecords">Users</a>
        <a href="/LibraryManagementFinal/lendrequestlist">Request List</a>
        <a href="/LibraryManagementFinal/lentlist">Lent Books</a>
        <a href="/LibraryManagementFinal/lendhistory">Lend/Return History</a>
      </div>
      <div class="content">
        <a href="/LibraryManagementFinal/publisherrecords">Back to Publishers List</a>
        <hr/>
        <span class="userfriendly">
            <div style="text-align: center;">
           <h3 style="color: #009999;">Edit Publisher</h3>
        </div>
         <form:form method="POST" action="savePublishers">
        <br/>
           <label>Publisher Name</label>
           <br/>
           <form:input type="text" size="50%" path="publishername"/>
           <br/><br/>
           <button class="addauthorbutton" style="vertical-align:middle; width:15%" onclick="showAlert()"><span>Update Publisher</span></button>
          </form:form>
        </span>
