...
<body>
    <div class="container">
        ...
        <div class="LogoImg">
            <a href="/LibraryManagementFinal/"><img src="resources/images/others/books.png"/> </a>
        </div>
    ...
    <div id="navbar">
      ...
      <div class="content">
        ...
        <span class="userfriendly">
           ...
           <h3 style="color: #009999;">Edit Book</h3>
        </div>
        <br/>
        <form:form method="POST" action="saveBooks">
          ...
          <c:forEach var="authorlst" items="${editauthorlist}">
            <option>${authorlst.authorid}</option>
            </c:forEach>
           </form:select> 
            <br/><br/>
           ...
           transition: 0.5s;" path="publisherid">
            <c:forEach var="publisherlst" items="${editpublisherlist}">
            <option>${publisherlst.publisherid}</option>
            </c:forEach>
           </form:select> 
           <br/><br/>
           ...
           <br/><br/>
           <button class="addbooksbutton" style="vertical-align:middle" onclick="showAlert()"><span>Update Book</span></button>
        </form:form>
        </span>
